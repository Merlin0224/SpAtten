...
### 序列长度扩展性测试 (SpAtten vs. Dense)
实验显示了稀疏化（SpAtten）在不同序列长度下的“临界点”效应：

| 序列长度 | 原生实现 (ms) | SpAtten (ms) | 加速比 (Speedup) |
| :--- | :--- | :--- | :--- |
|128        | 4.80            | 11.45              | 0.42      x
|256        | 4.67            | 11.08              | 0.42      x
|512        | 5.11            | 11.40              | 0.45      x
|1024       | 9.78            | 11.38              | 0.86      x
|2048       | 21.10           | 21.33              | 0.99      x
|4096       | 69.52           | 56.49              | **1.23x**
---
